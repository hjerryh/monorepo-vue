<template>
  <el-form ref="formRef" style="max-width: 600px" :model="numberValidateForm" label-width="auto" class="demo-ruleForm">
    ...
    >
      <el-input v-model.number="numberValidateForm.money" type="text" autocomplete="off" />
    </el-form-item>
    <el-form-item label="格式化后的金额" prop="amount">
      <el-input v-model="numberValidateForm.amount" type="text" autocomplete="off" readonly />
    </el-form-item>
    <el-form-item>
...
import { formatMoney } from "@pkg/utils";
...
console.log("numberValidateForm", numberValidateForm);
